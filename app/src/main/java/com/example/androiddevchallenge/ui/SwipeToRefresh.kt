...
/*
 * Copied from https://github.com/android/compose-samples/blob/master/JetNews/app/src/main/java/com/example/jetnews/ui/SwipeToRefresh.kt
 */
...
fun SwipeToRefreshLayout(
    ...
    val refreshingState by rememberUpdatedState(refreshingState)
